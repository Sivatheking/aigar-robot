...
def get_user_list(config, key):
    with open('{}/MikuXProBot.config/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_ID = "5077267318" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Sivatheking_1"
    SUPPORT_CHAT = 'shukurenai_chat'  #Your own group for support, do not add the @
